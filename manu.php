	...
	<!-- banner section start -->
		<div class="container-fluid">
			<div class="banner_main">
				<h1 class="banner_taital">Select City</h1>
			 <!--	<div class="input-group btn_main">
                ...
                <div class="bt_main">
                	<button class="btn_left" style="width:300px; height:200px;  "  ><font size="+10"><a href="http://localhost/glassgrid/job-finding/listPuneManu.php" style="color: #fff;"> Pune</a></font></button>
                	<button class="btn_right" style="width:300px; height:200px;  "  ><font size="+10"><a href="http://localhost/glassgrid/job-finding/listMumbaiManu.php" style="color: #fff;"> Mumbai</a></font></button>
                </div>
