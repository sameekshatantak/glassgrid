                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <div class="col-sm-12">
                    <a class="btn btn-info " target="__blank" href="Manufacturerusers.php"  style="background-color:  #92D9D3;">Chats</a>
                    </div>
                    <p><a href="http://localhost/glassgrid/job-finding/productinfo.php"   <button class="btn btn-outline-primary" style="background-color:  #92D9D3;">Add new Product</button></a></p>
                    <p>  <a href="http://localhost/glassgrid/job-finding/productManu.php" > <button class="btn btn-outline-primary" style="background-color:  #92D9D3;">View your Products</button></a> </p> 
                    <p>  <a href="http://localhost/glassgrid/job-finding/manuorders.php"> <button class="btn btn-outline-primary"style="background-color:  #92D9D3;">View orders</button></a> </p>  
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                    <a class="btn btn-info" target="__blank" href="Manufactureredit.php" style="background-color:  #92D9D3;">Edit</a>
                    <br>
